...
export default {
  ...
  computed: {
    defaultDateTimeFormat () {
      return DEFAULT_DATE_FORMAT + 'T' + DEFAULT_TIME_FORMAT
    },
    displayedDateTime () {
      return this.selectedDatetime ? this.$moment(this.selectedDatetime).format('YYYY-MM-DD HH:mm') : ''
    },
    formattedDatetime () {
      return this.selectedDatetime ? this.$moment(this.selectedDatetime).format('YYYY-MM-DDTHH:mm') : ''
    },
    selectedDatetime () {
  ...
  methods: {
    init () {
      ...
      let moment = this.$moment(initDateTime)
